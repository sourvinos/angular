...
export class EmployeeService {
    ...
    employees: employee[] = [
        { id: 1, name: 'Mark', gender: 'Male', contactPreference: 'Email', email: 'mark@hotmail.com', dateOfBirth: '1975/01/05', department: '1', isActive: true, photoPath: 'assets/mark.png', age: '12.6',salary:1234.63 },
